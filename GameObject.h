...
namespace gm {
	...
	public:
		...
		//will be recreated in the paddle and the ball
		//	setPosition(getPosition() + getVelocity + moveSpeed);
		virtual void move(sf::Vector2f& getVelocity) = 0;	//should be pure virtual
